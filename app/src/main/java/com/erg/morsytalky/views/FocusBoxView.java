package com.erg.morsytalky.views;
...
public class FocusBoxView extends View {
    ...
    private static final String TAG = "FocusBoxView";
    ...
    public FocusBoxView(Context context, AttributeSet attrs) {
        ...
        colorMask = resources.getColor(R.color.focus_box_mask);
        colorFrame = resources.getColor(R.color.focus_box_frame);
        colorCorner = resources.getColor(R.color.focus_box_corner);
