...
public class CameraEngine implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public CameraEngine(Activity context, AutoFitTextureView mTextureView) {
        this.context = context;
        this.mTextureView = mTextureView;
        cameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
    }

    public CameraEngine(Activity context) {
        this.context = context;
    }
    ...
    private void requestCameraPermission() {
        if (shouldShowRequestPermissionRationale(context,Manifest.permission.CAMERA)) {
            Toast.makeText(context, context.getString(R.string.request_permission),
    ...
    private void setUpCameraOutputs(int width, int height) {
        try {
            ...
            Toast.makeText(context, context.getString(R.string.camera_error), Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(context, context.getString(R.string.request_permission), Toast.LENGTH_LONG)
                        .show();
            }
        } else {
    ...
    public void switchFlash(ImageView flashButton) {
        try {
